...
print('health done!!!')
path_invitations = invitations_docs(entity_list=['Lista','de','autoridades'],event="Nome do evento",dates=('2018-02-21','2018-02-22'),place='Local do evento',admin_name='A equipa de gestão')
print('invites done!!!')
